...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  -f, --file FILE       Texts file path"
...
if [ ! -f "$TEXTS_FILE" ]; then
    echo "Error: Texts file not found: $TEXTS_FILE"
    exit 1
fi

echo "=========================================="
echo "Qwen3-Embedding RK3588 Batch Test"
echo "=========================================="
...
./demo "$LLM_MODEL" "$MAX_CONTEXT_LEN" "$NPU_CORES" "batch" "$TEXTS_FILE"
