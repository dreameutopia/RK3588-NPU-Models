...
echo "=========================================="
echo "Building Qwen3-Embedding Demo for $TARGET_PLATFORM"
echo "=========================================="
...
echo ""
echo "Next steps:"
echo "1. Copy model to install/demo_Linux_aarch64/models/"
echo "   cp /path/to/Qwen3-Embedding-0.6B-rk3588-w8a8_g256-opt-1-hybrid-ratio-0.0.rkllm install/demo_Linux_aarch64/models/"
echo ""
...
echo "   ./run.sh"
echo ""
echo "5. Single embedding test:"
echo "   ./test_single.sh"
echo ""
echo "6. Batch embedding test:"
echo "   ./test_batch.sh"
echo ""
echo "7. Evaluation test:"
echo "   ./test_eval.sh"
