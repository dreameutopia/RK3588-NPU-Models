...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  -t, --target TARGET     Target platform: rk3588, rk3576 (default: rk3588)"
    ...
    echo "  $0 -t rk3576                    # Build for RK3576"
...
echo "   cp /path/to/deepseekocr_vision_rk3588.rknn install/demo_Linux_aarch64/models/"
echo "   cp /path/to/deepseekocr_w4a16_rk3588.rkllm install/demo_Linux_aarch64/models/"
echo ""
