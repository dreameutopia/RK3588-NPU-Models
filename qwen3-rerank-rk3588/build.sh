...
echo "=========================================="
echo "Building Qwen3-Rerank Demo for $TARGET_PLATFORM"
echo "=========================================="
...
echo "   cp /path/to/Qwen3-Reranker-0.6B-rk3588-w8a8_g256-opt-1-hybrid-ratio-0.0.rkllm install/demo_Linux_aarch8/models/"
echo ""
...
echo "   ./run.sh"
echo ""
echo "5. Single query test:"
echo "   ./test_single.sh"
echo ""
echo "6. Batch rerank test:"
echo "   ./test_batch.sh"
