...
echo "=========================================="
echo "Setting up Qwen3-Rerank RK3588 deployment"
echo "=========================================="
...
echo "   cp /path/to/Qwen3-Reranker-0.6B-rk3588-w8a8_g256-opt-1-hybrid-ratio-0.0.rkllm models/"
echo ""
...
echo "   ./run.sh"
echo ""
echo "6. Single query test:"
echo "   ./test_single.sh"
echo ""
echo "7. Batch rerank test:"
echo "   ./test_batch.sh"
