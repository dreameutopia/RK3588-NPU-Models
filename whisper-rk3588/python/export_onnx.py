...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, required=False, default='base',
    ...
    parser.add_argument('--output_dir', type=str, required=False, default='../onnx', help='output directory')
    ...
    save_encoder_model_path = os.path.join(args.output_dir, f"whisper_encoder_{args.model_type}.onnx")
    save_decoder_model_path = os.path.join(args.output_dir, f"whisper_decoder_{args.model_type}.onnx")
    
    print(f"\nExporting encoder model to {save_encoder_model_path}...")
    torch.onnx.export(
        model.encoder, 
        (x_mel), 
    ...
    print(f"Exporting decoder model to {save_decoder_model_path}...")
    torch.onnx.export(
        model.decoder, 
    ...
    print("\nSimplifying encoder model...")
    simplify_onnx_model(save_encoder_model_path)
    print("The encoder model is saved in:", save_encoder_model_path)
    
    print("\nSimplifying decoder model...")
