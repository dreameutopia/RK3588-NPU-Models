...
echo "=========================================="
echo "Building InternVL3 Demo for $TARGET_PLATFORM"
echo "=========================================="
...
echo "   cp /path/to/internvl3-1b_vision_fp16_rk3588.rknn install/demo_Linux_aarch64/models/"
echo "   cp /path/to/internvl3-1b_w8a8_rk3588.rkllm install/demo_Linux_aarch64/models/"
echo ""
