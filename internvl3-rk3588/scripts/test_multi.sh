...
VISION_MODEL=$(find_model "internvl3-1b_vision_fp16_rk3588.rknn")
LLM_MODEL=$(find_model "internvl3-1b_w8a8_rk3588.rkllm")
...
if [ -z "$VISION_MODEL" ] || [ ! -f "$VISION_MODEL" ]; then
    ...
    echo "  ./models/internvl3-1b_vision_fp16_rk3588.rknn"
    echo "  ../models/internvl3-1b_vision_fp16_rk3588.rknn"
    exit 1
fi
...
if [ -z "$LLM_MODEL" ] || [ ! -f "$LLM_MODEL" ]; then
    ...
    echo "Please copy model to one of these locations:"
    echo "  ./models/internvl3-1b_w8a8_rk3588.rkllm"
    echo "  ../models/internvl3-1b_w8a8_rk3588.rkllm"
    exit 1
fi

echo "=========================================="
echo "InternVL3 RK3588 Multi-Image Concurrent Test"
echo "=========================================="
...
run_single_test() {
    local image_path=$1
    local task_id=$2
    local log_file="/tmp/internvl3_task_${task_id}.log"
