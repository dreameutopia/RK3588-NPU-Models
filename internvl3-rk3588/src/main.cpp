...
int main(int argc, char** argv)
{
    if (argc < 7) {
        std::cerr << "Usage: " << argv[0]
                ...
                << "  img_start         Image start token (default: <img>)\n"
                << "  img_end           Image end token (default: </img>)\n"
                << "  img_content       Image content token (default: <IMG_CONTEXT>)\n";
        return -1;
    }
