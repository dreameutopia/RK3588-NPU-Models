...
echo "=========================================="
echo "Setting up Qwen3-VL RK3588 deployment"
echo "=========================================="
...
echo "   cp /path/to/qwen3-vl-2b_vision_rk3588.rknn models/"
echo "   cp /path/to/qwen3-vl-2b-instruct_w8a8_rk3588.rkllm models/"
echo ""
